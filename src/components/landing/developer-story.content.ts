...
const developerStoryContent: DeclarationContent = {
  key: "developer-story",
  content: {
    ...
    enthusiast: t({ en: "Finances & Economics, dAPPs & Blockchain Enthusiast", fr: "Passionné de finances et d'économie, de dAPPs et de blockchain" }),
    mission: t({ en: "\"Our mission is simple: To empower individuals with the tools and knowledge they need to take control of their finances, break free from financial stress, and build a more secure financial future.\"", fr: "\"Notre mission est simple : donner aux individus les outils et les connaissances dont ils ont besoin pour prendre le contrôle de leurs finances, se libérer du stress financier et se construire un avenir financier plus sûr.\"" }),
  },
};

export default developerStoryContent;
