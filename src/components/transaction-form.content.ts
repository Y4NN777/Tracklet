...
const transactionFormContent: DeclarationContent = {
  ...
  content: {
    ...
    budgetOptional: t({ en: "Budget (Optional)", fr: "Budget (Facultatif)" }),
    selectBudget: t({ en: "No budget assignment", fr: "Aucune affectation budgétaire" }),
    chooseBudget: t({ en: "Optionally assign this transaction to a specific budget for accurate tracking.", fr: "Affectez éventuellement cette transaction à un budget spécifique pour un suivi précis." }),
