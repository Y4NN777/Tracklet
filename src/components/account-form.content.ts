...
const accountFormContent: DeclarationContent = {
  ...
  content: {
    ...
    bankAccountOption: t({ en: "Bank Account - Traditional banking", fr: "Compte Bancaire - Banque traditionnelle" }),
    savingsAccountOption: t({ en: "Savings - High-interest savings", fr: "Épargne - Épargne à intérêt élevé" }),
    creditCardOption: t({ en: "Credit Card - Credit card or prepaid card accounts", fr: "Carte de Crédit - Comptes de carte de crédit ou de carte prépayée" }),
    investmentAccountOption: t({ en: "Investment - Retirement, stocks, crypto etc.", fr: "Investissement - Retraite, actions, crypto, etc." }),
    mobileMoneyOption: t({ en: "Mobile Money - Orange Money, Wave, Moov Money, etc.", fr: "Mobile Money - Orange Money, Wave, Moov Money, etc." }),
    cashOption: t({ en: "Cash - Physical money", fr: "Espèces - Argent physique" }),
    businessFundOption: t({ en: "Business Fund - Small business capital", fr: "Fonds Commercial - Capital petite entreprise" }),
    otherAccountOption: t({ en: "Other - Miscellaneous accounts", fr: "Autre - Comptes divers" }),
