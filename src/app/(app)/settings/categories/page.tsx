        ...
        {Object.entries(categoriesByType).map(([type, typeCategories]) => (
          <div key={type} className="space-y-4">
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-semibold capitalize">{type} Categories</h2>
            ...
            <MobileDataList
              ...
              emptyState={{
                ...
                description: `Add your first ${type} category to get started.`,
              }}
            />
          </div>
        ))}
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center h-[300px] space-y-4">
                ...
                <p className="text-muted-foreground text-center max-w-md">
                  Create categories to organize your income and expenses for better financial tracking.
                </p>
