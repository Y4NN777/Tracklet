    ...
    <>
      ...
      <CardContent>
              ...
              <SelectContent>
                {categories.map((category) => (
                  <SelectItem key={category} value={category}>
                    {category === 'all' ? i.allCategories : category}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
        ...
        <MobileDataList
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className={`text-base sm:text-lg font-semibold ${
                      ...
                      {Math.abs(transaction.amount).toLocaleString(i.locale, {
                        style: 'currency',
          ...
          emptyState={{
            title: i.emptyFilteredTitle,
            description: i.emptyFilteredDescription,
          }}
        />
      </CardContent>
      </Card>
