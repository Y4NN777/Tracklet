    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {i.changePasswordDescription}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <form onSubmit={handleChangePassword} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="current-password">{i.currentPasswordLabel}</Label>
              <Input
                id="current-password"
                type="password"
      ...
      <Card>
        <CardHeader>
          <CardTitle>{i.deleteAccountTitle}</CardTitle>
          <CardDescription>
            {i.deleteAccountDescription}
          </CardDescription>
        </CardHeader>
        <CardContent>
